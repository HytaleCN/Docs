...
> 原文链接：[https://support.hytale.com/hc/en-us/articles/45326769420827-Hytale-Server-Manual](https://support.hytale.com/hc/en-us/articles/45326769420827-Hytale-Server-Manual)
...
> **注意：**在没有专用工具的情况下，很难准确判断 Java 进程实际需要多少已分配的 RAM。请通过尝试不同的 Java `-Xmx` 参数值来设置明确的上限。内存压力的一个典型表现是由于垃圾回收而导致的 CPU 使用率上升。
